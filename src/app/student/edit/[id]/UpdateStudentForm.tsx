...
export default function UpdateStudentForm({ initialData }: { initialData: StudentWithEnrollment }) {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    if (validate()) {
      const result = await updateStudent(formData as EnrollSchema, initialData.id)
          ...
          <div className='space-y-4 flex flex-col gap-3 px-4 py-3' >
            <div className='flex  gap-2 flex-col'>
              <div className='pb-2'>
                ...
                <RadioGroup
                  label='Sex'
                  defaultValue={formData.sex} orientation='horizontal'
                  onValueChange={(e) => {
                    setFormData((prev) => ({
                      ...prev,
                      sex: e as Sex
              ...
              <Button type='submit' className='mt-4' color='secondary'>Update</Button>
            </div>
          </div>
        </form>
      </CardBody >
