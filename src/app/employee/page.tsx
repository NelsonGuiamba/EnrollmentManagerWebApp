...
export default async function Home() {
  ...
  if (session)
    if (session.user) {
      ...
      if (data.length === 0) return <NoStudents />;
            ...
            <div className="flex flex-col gap-8">
              {students.map((student) => {
                ...
                if (approved.has(student.id)) {
                  ...
                  student.enrollment?.processedById === session.user.id &&
                ...
                else footer = <StudentDetailFooter student={student} />;
